      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl lg:text-2xl text-muted-foreground mb-8 leading-relaxed font-light">
            We are a digital solutions and platform-enabling company crafting compelling applications, 
            solutions, and websites focused on the real-world needs of small and medium enterprises.
          </p>
